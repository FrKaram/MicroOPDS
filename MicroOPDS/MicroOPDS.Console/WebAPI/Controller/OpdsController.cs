...
namespace MicroOPDS.Console
{
    //[RoutePrefix("opds")]
    [JsonOutput]
    public class opdsController : ApiController
    {
        //[Route("")]
        [HttpGet]
        public String Get(String data)
        {
            ...
            //return Request.CreateResponse(HttpStatusCode.OK, "Hello", new AtomXmlMediaTypeFormatter()); | Force the output to be formatted with the selected formatter
            return "Hello";
        }
